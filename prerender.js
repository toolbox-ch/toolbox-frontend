...
function generatePageHTML(route, seoData) {
  ...
  // Generate static content that matches the actual React components
...
<html lang="en">
  <head>
    ...
    <script type="module" crossorigin src="/assets/index-Qgv0XW2R.js"></script>
...
function generateStaticPageContent(route, seoData) {
  ...
  } else if (route.startsWith('/pdf-tools/') || route.startsWith('/datei-tools/') || route.startsWith('/bild/')) {
    return generateToolPageContent(route, h1, description);
  } else if (route === '/alle-tools') {
    return generateAlleToolsContent();
  } else if (route === '/alle-vorlagen') {
    return generateAllTemplatesContent();
  } else {
...
function generateToolPageContent(route, h1, description) {
  return `
    <div class="min-h-screen flex flex-col">
      <div class="bg-card border-b sticky top-0 z-50 backdrop-blur-sm bg-card/95">
        <div class="container mx-auto px-4 py-4">
...
function generateAlleToolsContent() {
  return `
    <div class="min-h-screen flex flex-col">
      <div class="bg-card border-b sticky top-0 z-50 backdrop-blur-sm bg-card/95">
        <div class="container mx-auto px-4 py-4">
...
function generateAllTemplatesContent() {
  return `
    <div class="min-h-screen flex flex-col">
      <div class="bg-card border-b sticky top-0 z-50 backdrop-blur-sm bg-card/95">
        <div class="container mx-auto px-4 py-4">
...
async function prerender() {
  console.log("🚀 Starting clean SSR prerendering...");
